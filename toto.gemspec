...
Gem::Specification.new do |s|
  ...
  s.authors = ["mclaughj"]
  s.date = %q{2012-11-01}
  s.description = %q{a sweet blogging engine}
  s.email = %q{josephmclaughlin@me.com}
  s.extra_rdoc_files = [
    "LICENSE",
    "README.md",
    "TODO"
  ...
  s.homepage = %q{http://github.com/mclaughj/toto}
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.6}
  s.summary = %q{a quick trip around the blogosphere}
